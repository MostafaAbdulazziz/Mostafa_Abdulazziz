...
export const metadata: Metadata = {
	...
	authors: [{ name: 'Mostafa Abdulazziz' }],
	creator: 'Mostafa Abdulazziz',
	openGraph: {
		title: 'Mostafa Abdulazziz - Software Developer Portfolio',
		...
		siteName: 'Mostafa Abdulazziz - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Mostafa Abdulazziz - Modern Minimal Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
