					...
					>
						...
						<div className="absolute inset-0 p-6 flex flex-col justify-end">
							...
							<div className="flex gap-4">
								<Link href={project.viewProjectLink} className="text-sm px-4 py-2 bg-white/10 hover:bg-white/20 rounded-full transition-colors">
									View Project
								</Link>
								<Link href={project.githubLink} className="text-sm px-4 py-2 bg-white/10 hover:bg-white/20 rounded-full transition-colors">
									GitHub
								</Link>
							</div>
						</div>
